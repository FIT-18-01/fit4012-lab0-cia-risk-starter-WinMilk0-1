...
## Ghi chú thêm
- Khó khăn gặp phải: Xác định chính xác threat và mitigation cho sự cố B.
- Cách em xử lý: Đọc kỹ đề bài, phân tích mỗi sự cố theo CIA và chọn mitigation phù hợp cho integrity.
- Điều em học được từ bài lab: Hệ thống lưu điểm cần bảo vệ cả tính sẵn sàng, tính toàn vẹn và tính riêng tư; kiểm soát truy cập và ghi nhật ký audit là hai biện pháp quan trọng.
